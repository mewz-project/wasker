            ...
            ******************************/
            Operator::I32WrapI64 => {
                let v = environment
                    ...
                    .expect("stack empty")
                    .into_int_value();
                let wraped = environment.builder.build_int_truncate(
                    v,
                    environment.inkwell_types.i32_type,
                    "",
                );
            ...
            Operator::I64Extend16S => {
                ...
                let narrow_value = environment.builder.build_int_truncate(
                    v,
                    environment.inkwell_types.i16_type,
                    "",
                );
                let extended = environment.builder.build_int_s_extend(
                    narrow_value,
            ...
            Operator::GlobalGet { global_index } => {
                ...
                match global {
                    ...
                    Global::Mut { ptr_to_value, ty } => {
                        let value = environment.builder.build_load(
                            *ty,
                            ptr_to_value.as_pointer_value(),
                            "",
                        );
                        environment.stack.push(value);
                    }
