...
(module
  ...
  ;; TODO: support externref
  ;; (func $meet-externref (param i32) (param externref) (result externref)
  ...
  (func (export "_start")
    ...
    (call $assert_test_i32 (call $type-i64-value) (i64.const 2))
    (call $assert_test_f32 (call $type-f32-value) (f32.const 3))
    (call $assert_test_f64 (call $type-f64-value) (f64.const 4))

    (call $assert_test_i32 (call $empty (i32.const 0)) (i32.const 22))
    (call $assert_test_i32 (call $empty (i32.const 1)) (i32.const 22))
    (call $assert_test_i32 (call $empty (i32.const 11)) (i32.const 22))
    (call $assert_test_i32 (call $empty (i32.const -1)) (i32.const 22))
    (call $assert_test_i32 (call $empty (i32.const -100)) (i32.const 22))
    (call $assert_test_i32 (call $empty (i32.const 0xffffffff)) (i32.const 22))
