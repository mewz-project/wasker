...
(module
  ...
  (func $fill
    (memory.fill (i32.const 48) (i32.const 0x11) (i32.const 4))
  )
  ...
  (func $test_filled
    ...
    (call $assert_test_i32 (call $load8_u (i32.const 46)) (i32.const 6))
    (call $assert_test_i32 (call $load8_u (i32.const 47)) (i32.const 0))
    (call $assert_test_i32 (call $load8_u (i32.const 48)) (i32.const 0x11))
    (call $assert_test_i32 (call $load8_u (i32.const 49)) (i32.const 0x11))
    (call $assert_test_i32 (call $load8_u (i32.const 50)) (i32.const 0x11))
    (call $assert_test_i32 (call $load8_u (i32.const 51)) (i32.const 0x11))
  )  
  (func (export "_start")
    (call $test_init)
    (call $fill)
